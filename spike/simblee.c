...
int main(int argc, char **argv)
{
	...
	strftime(time_chars,sizeof(time_chars),"BLE_LOG_%Y_%m_%d_%H_%M_%S.csv",&tm_info);
	
	fp=fopen(time_chars, "w");
	
	fprintf(fp,"Date,Time,Data_Type,Data,Address\n");
